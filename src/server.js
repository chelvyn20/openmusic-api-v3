...
// songs in playlist
const songsInPlaylist = require('./api/songsInPlaylist');
const SongsInPlaylistService = require('./services/postgres/SongsInPlaylistService');
const SongsInPlaylistValidator = require('./validator/songsInPlaylist');
...
const init = async () => {
  ...
  const songsInPlaylistService = new SongsInPlaylistService(cacheService);
  ...
  await server.register([
    ...
    {
      plugin: songsInPlaylist,
      options: {
        songsInPlaylistService,
        playlistsService,
        validator: SongsInPlaylistValidator,
      },
    },
    {
